...
\begin{figure}[htbp]
  \centering
  \IfFileExists{../图/fig_qone_main.pdf}{%
    \includegraphics[width=0.85\linewidth]{fig_qone_main.pdf}%
  }{%
    \IfFileExists{fig_qone_main.pdf}{%
      \includegraphics[width=0.85\linewidth]{fig_qone_main.pdf}%
    }{%
...
% 【固定句式，确保表与图都被真正使用】
% 由表 \ref{tab:qone-result} 可知……；从图 \ref{fig:qone-main} 可以看出……；
