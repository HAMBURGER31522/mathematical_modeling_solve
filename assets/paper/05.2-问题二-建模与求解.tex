...
\begin{figure}[htbp]
  \centering
  \IfFileExists{../图/fig_qtwo_main.pdf}{%
    \includegraphics[width=0.85\linewidth]{fig_qtwo_main.pdf}%
  }{%
    \IfFileExists{fig_qtwo_main.pdf}{%
      \includegraphics[width=0.85\linewidth]{fig_qtwo_main.pdf}%
    }{%
...
% 【固定句式，确保表与图都被真正使用】
% 由表 \ref{tab:qtwo-result} 可知……；从图 \ref{fig:qtwo-main} 可以看出……；
